      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            ...
            children: [
              ...List.generate(homeProviderT.offerProducts.length, (index) => OfferProductBox(product: homeProviderT.offerProducts[index],),),
            ],
          ),
        ),
      ],
                  ...
                  Row(
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        child: Text('-${product.discountPercentage.toInt()}%', style: Theme.of(context).textTheme.titleMedium,),
                      ),
                    ],
                  ),
                ],
